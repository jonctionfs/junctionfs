...
export const createConnection = async (provider: Provider, userId: string) => {

  const client = new OauthClient(provider.credentials as OauthTokens)
...
export const newConnection = async (
  ...
  return await createConnection(provider, userId)
}
